...
import (
	...
	"github.com/F3r-n4nd0/WallStreetCustomer/src/report/service"
	"github.com/F3r-n4nd0/WallStreetCustomer/src/report/usecase"
...
func main() {
	...
	wallStreetServices := service.NewCustomerOneStockChangeService(rabbitMqChannel, rabbitMqKeyQueueTradeForeCasting)

	reportUseCase := usecase.NewReportUseCase(wallStreetServices,2)

	reportUseCase.StartReceiveInformationWallStreet()
...
func configureLog() {
	file, err := os.OpenFile("./wallStreetCustomer.log", os.O_CREATE|os.O_WRONLY, 0666)
	if err == nil {
